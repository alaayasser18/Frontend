...
const ActivityLog = () => {
  ...
  }, [auditLogs, activeFilter, searchQuery, t]);
  ...
  const handleExport = () => {
    const exportData = {
      ...
      logs: filteredLogs.map((log) => ({
        ...
        action: t(log.action),
        actor: log.actor,
        timestamp: t(log.timestamp),
        severity: t(
          `auditLogs.filter${log.severity}`
        ),
      })),
    };
          ...
          <table className="w-full text-left rtl:text-right border-collapse">
            <thead>
              <tr className="border-b border-[#f1f5f9] text-[11px] font-bold text-[#94a3b8] tracking-wider uppercase">
                ...
                <th className="pb-3.5 px-4">
                  {t("auditLogs.colTimestamp")}
                </th>

                <th className="pb-3.5 px-2">
                  {t("auditLogs.colSeverity")}
                </th>
              </tr>
            </thead>
